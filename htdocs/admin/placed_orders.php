...
if(isset($_POST['update_payment'])){
   ...
   $message[] = 'statut de payment modifier!';
}
   ...
   <div class="box">
      ...
      <form action="" method="post">
        ...
        <div class="flex-btn">
         ...
         <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('suprimer cette commande?');">suprimer</a>
        </div>
      </form>
   </div>
   <?php
