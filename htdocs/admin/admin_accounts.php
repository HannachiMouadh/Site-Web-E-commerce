...
<section class="accounts">
   ...
   <div class="box">
      ...
      <a href="register_admin.php" class="option-btn">inscrire admin</a>
   </div>
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="admin_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('suprimer ce compte?')" class="delete-btn">suprimer</a>
         <?php
