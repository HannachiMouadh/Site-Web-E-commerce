...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>ce connecté maintenant!</h3>
      <p>nom d'utilisateur par default = <span>admin</span> & mot de pass = <span>111</span></p>
      ...
      <input type="submit" value="connecté vous maintenant" class="btn" name="submit">
   </form>
